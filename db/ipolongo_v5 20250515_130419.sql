...
CREATE TABLE `smc_inventory_central` (
  ...
  `location_type` varchar(50) DEFAULT NULL COMMENT 'central | facility',
...
CREATE TABLE `smc_inventory_transaction` (
  ...
  `transaction_type` int(11) NOT NULL COMMENT 'in (add) - out (less)',
...
) ENGINE=InnoDB AUTO_INCREMENT=6917 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

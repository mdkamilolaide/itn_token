    ...
    setup() {
        ...
        function downloadReport(i, total) {
            ...
            const map = {
                ...
                2: { fileName: 'i-9b_Forms_' + total + '_' + today, dlString: 'qid=702' },
                3: { fileName: 'i-9c_Forms_' + total + '_' + today, dlString: 'qid=703' },
                4: { fileName: '5_Percent_Revisit_Forms_' + total + '_' + today, dlString: 'qid=704' },
                5: { fileName: 'End_Process_Forms_' + total + '_' + today, dlString: 'qid=705' },
                7: { fileName: 'SMC_Supervisory_CDD_Forms_' + total + '_' + today, dlString: 'qid=706' },
                8: { fileName: 'SMC_Supervisory_HFW_Forms_' + total + '_' + today, dlString: 'qid=707' },
            };
            const cfg = map[i] || map[5];

            overlay.show();
            const downloadMax = (window.common && window.common.ExportDownloadLimit) || 25000;

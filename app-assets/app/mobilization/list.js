/**
 * Mobilization / List — Vue 3 Composition API in place.
 * Three components — page-body, mobilization_list, mobilization_details.
 *
 * EventBus events preserved: g-event-goto-page, g-event-update-user.
 * jQuery select2 + flatpickr init kept in onMounted with destroy on unmount.
 */
    ...
    template: `
        <div>
            <div class="content-body">
                <div v-show="page == 'list'"><mobilization_list/></div>
...
const MobilizationList = {
    setup() {
        ...
        const loadTableData = () => {
            ...
            axios.get(
                u + '?qid=301&draw=' + tableOptions.currentPage +
        ...
        return {
            ...
            tableOptions, sysDefaultData, userPass,
                        ...
                        <table class="table table-hover">
                            <thead>
                                <tr>
                                    ...
                                    <th @click="sort(4)">Mobilized Household
                                    ...
                                    <th @click="sort(11)">Mobilized Date
                            ...
                            <tbody>
                                <tr v-for="(g, i) in tableData" :key="g.hhid || i" :class="checkedBg(g.pick)">
                                    <td>
...
useApp({ template: `<div><page-body/></div>` })
    ...
    .component('mobilization_list', MobilizationList)

...
// User List Page
Vue.component("mobilization_list", {
  data: function () {
    return {
            ...
            <div class="col-md-8 col-sm-12 col-12 mb-0">
                ...
                <div class="breadcrumb-wrapper">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Mobilization List </li>
                    </ol>
                </div>
            </div>
                        ...
                        <table class="table table-hover">
                            <thead>
                                <tr>
                                    ...
                                    $columns = array('hhid - 0','geo_string - 1','geo_level - 2','geo_name - 3','hoh_first - 4','hoh_last - 5',
                                                    'hoh_phone - 6','hoh_gender - 7','family_size - 8','allocated_net - 9','location_description - 10',
                                                    'collected_date - 11','mobilizer - 12','mobilizer_loginid - 12','mobilizer_userid - 13');
                            ...
                            <tbody>
                                    ...
                                    <td>
                                        <div class="d-flex justify-content-left align-items-center">
                                            <div class="d-flex flex-column">
                                                ...
                                                <small class="emp_post text-primary">{{g.mobilizer_loginid}}</small>
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="d-flex justify-content-left align-items-center">
                                            <div class="d-flex flex-column">
                                                ...
                                                <small class="emp_post text-primary text-left">
                                                    <span class="badge badge-light-primary">Family Size:</span>
                                                    <span class="text-muted"> {{g.family_size}} </span>
                                                </small>
                                            </div>
                                        </div>
                                    </td>
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu">
                                                ...
                                                <a class="dropdown-item" href="javascript:void(0);" data-toggle="modal" data-target="#geoLevelModal" data-backdrop="static" data-keyboard="false" @click="changeUserGeoLevelModal(g.userid, g.loginid, g.geo_level, g.geo_level_id)">
                                                    <i class="feather icon-user mr-50"></i>
                                                    <span>Change Geo Level</span>
                                                </a>
                                                <a class="dropdown-item" href="javascript:void(0);" data-backdrop="static" data-keyboard="false" data-toggle="modal" data-target="#roleForm" @click="changeUserRoleModal(g.userid, g.roleid)">
                                                    <i class="feather icon-user mr-50"></i>
                                                    <span>Change User Role</span>
                                                </a>
                                                <a class="dropdown-item" href="javascript:void(0);" data-backdrop="static" data-keyboard="false" data-toggle="modal" data-target="#resetPassword" @click="showPassResetModal(g.loginid, g.first +' '+ g.middle +' '+ g.last)">
                                                    <i class="feather icon-user mr-50"></i>
                                                    <span>Reset User Password</span>
                                                </a>
                                                <a class="dropdown-item" href="javascript:void(0);" @click="userActivationDeactivation(g.userid)">
                                ...
                                <tr v-if="tableData.length == 0"><td class="text-center pt-2" colspan="7"><small>No Mobilization Data</small></td></tr>
                            </tbody>
                        </table>

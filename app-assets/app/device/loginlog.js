/**
 * Device / Login Log submodule — Vue 3 Composition API in place.
 * qid=602 list with date / loginid / serial_no filters.
 */
...
const SampleTable = {
    setup() {
        ...
        const loadTableData = () => {
            ...
            axios.get(
                url +
                '?qid=602&draw=' + tableOptions.currentPage +
                ...
                '&dat=' + tableOptions.filterParam.date +
        ...
        return {
            tableData, filterState, filters, checkToggle, userGroup, permission, tableOptions,

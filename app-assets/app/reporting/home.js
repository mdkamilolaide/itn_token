...
Vue.component("reporting_lists", {
  data: function () {
    return {
      ...
      permission: getPermission(per, "reporting"),
      checkToggle: false,
      tableData: [],
      searchReport: "",
      dateTitle: "",
                        ...
                        <tbody>
                            <tr v-if="permission.permission_value >=1">
                                ...
                                <td class="text-center">
                                    <a href="javascript:void(0)" @click="openModal('participantList')" class="btn btn-sm btn-primary btn-sm p-25" data-backdrop="static" data-keyboard="false" data-toggle="modal" data-target="#trainingListModal"><i class="feather icon-download"></i></a>
                                </td>
                            </tr>
                            <tr v-if="permission.permission_value >=1">
                                <td>2</td>
                                ...
                                <td><span class="badge badge-light-success">Activity</span></td>
                                <td class="text-center">
                                    <a href="javascript:void(0)" @click="openModal('bankVerificationStatus')" class="btn btn-sm btn-primary btn-sm p-25" data-backdrop="static" data-keyboard="false" data-toggle="modal" data-target="#trainingListModal"><i class="feather icon-download"></i></a>
                                </td>
                            </tr>
                            <tr v-if="permission.permission_value >=1">
                                <td>3</td>
                                ...
                                <td><span class="badge badge-light-success">Activity</span></td>
                                <td class="text-center">
                                    <a href="javascript:void(0)" @click="openModal('unCapturedParticipant')" class="btn btn-sm btn-primary btn-sm p-25" data-backdrop="static" data-keyboard="false" data-toggle="modal" data-target="#trainingListModal"><i class="feather icon-download"></i></a>
                                </td>
                            </tr>
                            ...
                            <tr v-if="permission.permission_value ==3">
                                ...
                                <td class="text-center">
                                    <a href="javascript:void(0)" @click="openModal('distributionPerLGA')" class="btn btn-sm btn-primary btn-sm p-25" ><i class="feather icon-download"></i></a>
                                </td>
                            </tr>
                            <tr v-if="permission.permission_value ==3">
                                <td>10</td>
                                ...
                                <td><span class="badge badge-light-success">Distribution</span></td>
                                <td class="text-center">
                                    <a href="javascript:void(0)" @click="openModal('distributionPerDP')" class="btn btn-sm btn-primary btn-sm p-25"><i class="feather icon-download"></i></a>
                                </td>
                            </tr>
                            <tr v-if="permission.permission_value >=1">
                                <td>11</td>
                                ...
                                <td><span class="badge badge-light-success">Distribution</span></td>
                                <td class="text-center">
                                    <a href="javascript:void(0)" @click="openModal('distributionPerLGADated')" class="btn btn-sm btn-primary btn-sm p-25" data-backdrop="static" data-keyboard="false" data-toggle="modal" data-target="#trainingListModal"><i class="feather icon-download"></i></a>
                                </td>
                            </tr>
                            <tr v-if="permission.permission_value ==3">
                                <td>12</td>
                                ...
                                <td><span class="badge badge-light-success">Distribution</span></td>
                                <td class="text-center">
                                    <a href="javascript:void(0)" @click="openModal('distributionPerLGADateRange')" class="btn btn-sm btn-primary btn-sm p-25" data-backdrop="static" data-keyboard="false" data-toggle="modal" data-target="#trainingListModal"><i class="feather icon-download"></i></a>
                                </td>
                            </tr>
                            <tr v-if="permission.permission_value >=1">
                                <td>13</td>
                                ...
                                <td><span class="badge badge-light-success">Distribution</span></td>
                                <td class="text-center">
                                    <a href="javascript:void(0)" @click="openModal('distributionPerDPDated')" class="btn btn-sm btn-primary btn-sm p-25" data-backdrop="static" data-keyboard="false" data-toggle="modal" data-target="#trainingListModal"><i class="feather icon-download"></i></a>
                                </td>
                            </tr>
                            <tr v-if="permission.permission_value ==3">
                                <td>14</td>
                                ...
                                <td><span class="badge badge-light-success">Distribution</span></td>
                                <td class="text-center">
                                    <a href="javascript:void(0)" @click="openModal('distributionPerDPDateRange')" class="btn btn-sm btn-primary btn-sm p-25" data-backdrop="static" data-keyboard="false" data-toggle="modal" data-target="#trainingListModal"><i class="feather icon-download"></i></a>
                                </td>
                            </tr>
